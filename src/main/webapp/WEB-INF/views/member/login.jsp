                    ...
                    <div id="login-tab" class="tab-pane fade in active show">
                        <div class="col-12 col-xl-12 col-md-12 lg-padding-30px-lr md-padding-15px-lr sm-margin-40px-bottom">
                            ...
                            <form action="<c:url value="/login"/>" class="border-all border-color-medium-gray padding-4-rem-all lg-margin-35px-top md-padding-2-half-rem-all" method="POST">
                                <c:if test="${mode == 'login_fail' || mode == 'error'}">
                                ...
                                <div class="col-12 col-md-12 col-lg-12 alert alert-danger alert-dismissible fade in show" role="alert">
                                    ...
                                    <strong>경고!</strong> <spring:message code="msg.${mode}"/>
                                </div>
                                </c:if>
                                ...
                                <p class="text-right margin-20px-top mb-0"><a href="<c:url value="/forget"/>" class="btn btn-link  btn-medium text-extra-dark-gray"><spring:message code="label.member.toForget"/></a></p>
                            </form>
                        </div>
                    </div>
                    <!-- end tab item 로그인 폼 -->
                    ...
                    <div id="join-tab" class="tab-pane fade in">
                        <div class="col-12 col-xl-12 lg-padding-30px-lr md-padding-15px-lr sm-margin-40px-bottom">
                            ...
                            <form id="join-form" action ="<c:url value="/join"/>" method="post" class="bg-light-gray padding-4-rem-all lg-margin-35px-top md-padding-2-half-rem-all">
                                ...
                                <div class="text-right margin-20px-bottom">
                                    <input type="checkbox" class="d-inline-block align-middle w-auto mb-0 margin-5px-right" id="pass_show" value="1" onchange="pass_show_toggle()"><label for="pass_show"><spring:message
