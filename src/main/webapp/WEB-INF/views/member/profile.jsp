                            ...
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion-style-03-01" aria-expanded="false">
                                <div class="panel-title">
                                    ...
                                    <dl class="profile-card-content">
                                        ...
                                        <dd><span class="alt-font text-extra-dark-gray d-inline-block">${sessionScope.member.mem_email}</span></dd>
                                        ...
                                        <dd><span class="alt-font text-extra-dark-gray d-inline-block">${sessionScope.member.mem_name}</span></dd>
                                    </dl>
                            ...
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion4" href="#accordion-style-03-04" aria-expanded="false">
                                <div class="panel-title">
                                    ...
                                    <dl class="profile-card-content">
                                        ...
                                        <dd><span class="alt-font text-extra-dark-gray d-inline-block"><fmt:formatDate value="${sessionScope.member.mem_register_datetime}" pattern="yyyy-MM-dd"/></span></dd>
                                        ...
                                        <dd><span class="alt-font text-extra-dark-gray d-inline-block">
                                            <c:choose>
                                                <c:when test="${sessionScope.member.mem_class == 2}">
                                                    <spring:message code="label.member.info.other.class.admin"/>
                                                </c:when>
                                                <c:when test="${sessionScope.member.mem_class == 1}">
                                                    <spring:message code="label.member.info.other.class.excellent"/>
                                                </c:when>
                                                <c:otherwise>
                                                    <spring:message code="label.member.info.other.class.general"/>
                                                </c:otherwise>
                                            </c:choose>
                                        </span></dd>
                                    </dl>
